...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--run-dir", default="runs/seaships24790/yolov9s_baseline", help="YOLO run directory.")
    parser.add_argument("--model", default="YOLOv9-s", help="Model name for the table.")
    ...
    parser.add_argument("--markdown", default="results/yolov9s_seaships24790_summary.md", help="Output Markdown path.")
    parser.add_argument("--csv", default="results/yolov9s_seaships24790_summary.csv", help="Output CSV path.")
...
def main() -> None:
    ...
    markdown_path.write_text("# YOLOv9-s SeaShips24790 Result Summary\n\n" + table + "\n", encoding="utf-8")
