...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--run-dir", default="runs/seaships24790/yolov10s_baseline", help="YOLO run directory.")
    parser.add_argument("--model", default="YOLOv10-s", help="Model name for the table.")
    ...
    parser.add_argument("--markdown", default="results/yolov10s_seaships24790_summary.md", help="Output Markdown path.")
    parser.add_argument("--csv", default="results/yolov10s_seaships24790_summary.csv", help="Output CSV path.")
...
def main() -> None:
    ...
    weights_path = run_dir / "weights" / f"{args.prefer}.pt"
    ...
    markdown_path.write_text("# YOLOv10-s SeaShips24790 Result Summary\n\n" + table + "\n", encoding="utf-8")
