"""Evaluate a trained YOLOv9-s SeaShips24790 model and export tables."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate YOLOv9-s on SeaShips24790.")
    ...
    parser.add_argument("--name", default="yolov9s_eval", help="Eval run name.")
    parser.add_argument("--markdown", default="results/yolov9s_eval_summary.md", help="Output Markdown path.")
    parser.add_argument("--csv", default="results/yolov9s_eval_summary.csv", help="Output CSV path.")
...
def main() -> None:
    ...
    lines = [
        "# YOLOv9-s SeaShips24790 Evaluation Summary",
        "",
        "- Model: YOLOv9-s",
